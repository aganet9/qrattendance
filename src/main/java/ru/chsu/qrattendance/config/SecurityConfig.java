    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/teachers/**").hasAuthority("ROLE_TEACHER")
                        .requestMatchers(HttpMethod.PATCH, "/api/teachers/**").hasAuthority("ROLE_TEACHER")
                        .requestMatchers(HttpMethod.GET, "/api/subjects/**").hasAuthority("ROLE_TEACHER")
                        .requestMatchers(HttpMethod.GET, "/api/rooms/**").hasAuthority("ROLE_TEACHER")
                        .requestMatchers(HttpMethod.GET, "/api/statistics/**").hasAuthority("ROLE_TEACHER")
